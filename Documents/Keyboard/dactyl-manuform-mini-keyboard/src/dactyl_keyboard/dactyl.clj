...
(def usb-holder-cube   (cube 0 0 0))
(def usb-holder-space  (translate (map + usb-holder-position [0 (* -1 wall-thickness) 1]) usb-holder-cube))
(def usb-holder-holder (translate usb-holder-position (cube 0 0 0)))

(def usb-jack (translate (map + usb-holder-position [0 10 3]) (cube 12.1 200 6)))

(def pro-micro-position (map + (key-position 0 1 (wall-locate3 -1 0)) [-7 2 -15]))
(def pro-micro-space-size [3 10 12]) ; z has no wall;
...
(def trrs-holder-size [0 0 0]) ; trrs jack PJ-320A
(def trrs-holder-hole-size [0 0 0]) ; trrs jack PJ-320A
...
(defn screw-insert-all-shapes [bottom-radius top-radius height]
  (union (screw-insert 0 0         bottom-radius top-radius height [11 12 0])
